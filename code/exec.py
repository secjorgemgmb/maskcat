...
def execHashcat (mask):
    ...
    # "/Users/jorgemartinezgarcia/OneDrive - Universidad Rey Juan Carlos/TFG/maskcat/wordlists/rockyouMD5_1.txt", "-O", "--potfile-disable", "--logfile-disable", mask], stdout=subprocess.PIPE).stdout.decode("utf-8")
    ...
    r"../wordlists/top_1M_MD5.txt", "-d", "1", "-O", "--potfile-disable", mask], stdout=subprocess.PIPE).stdout.decode("utf-8")
