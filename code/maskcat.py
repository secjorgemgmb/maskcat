...
from maskcat_genetics import GeneticAlgorithm_Generational
...
class Maskcat ():
    ...
    def run(self):
        ...
        for i in range (0, maskcat_config.REPETITIONS):
            ...
            print(str(maskcat_config.POPULATION_SIZE * maskcat_config.GENERATION_NUMBER))
            
            if self.generational:
                algorithm = GeneticAlgorithm_Generational(problem=problem,
                                            population_size=maskcat_config.POPULATION_SIZE, 
                                            offspring_population_size=maskcat_config.POPULATION_SIZE,
                                            ...
                                            termination_criterion=StoppingByEvaluations(maskcat_config.POPULATION_SIZE * maskcat_config.GENERATION_NUMBER))
            else:
            ...
            progress_bar = observers.ProgressBarObserver(max=maskcat_config.POPULATION_SIZE * maskcat_config.GENERATION_NUMBER)
